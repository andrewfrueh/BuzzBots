...
M2_boltDiameter = 2.7; // actual 2.0
M2_boltHeadDiameter = 4.8; // actual 4
M2_nutHeight = 1.8; // actual 1.6
M2_nutDiameterMin = 4.0; // actual 4
M2_nutDiameterMax = M2_nutDiameterMin*(1/sin(60)); // actual 4.5
...
//stumpWithTrapNut(shaftDiameter=stepperMotor_diameter);
//stumpWithTrapNut(shaftDiameter=woodDowel_halfInch_diameter, stumpWallThick=6);
...
module stumpWithTrapNut(
	...
	stumpHeight = 10;
	stumpTrapNutOffsetY = shaftRadius + (stumpWallThick/2.5); // TODO, check this offset, I think it needs to be tweaked
