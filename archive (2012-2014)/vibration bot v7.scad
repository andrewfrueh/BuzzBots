...
buzzBotBigShaftWeight(length=75);
...
module buzzBotBigShaftWeight(
	...
	difference(){
		...
		// trap nut 
		translate([0,trapNutOffset,0]) trapNutDie(boltDiameter = M2_boltDiameter, nutHeight = M2_nutHeight, nutDiameterMin = M2_nutDiameterMin, nutDiameterMax = M2_nutDiameterMax, holeLength=length+(r1*2), holeOffset=(length/2)+(r1/2), boltHoleRes=6 );
